...
locals {
  # merge tags
  local_tags = {
    "Name" = "ecs-applicaecs_applicationtion"
  }
...
inputs = {
  ...
  ecs_task = {
    ...
    container_image          = "730335543129.dkr.ecr.ap-south-1.amazonaws.com/frontend:latest"
...
terraform {
  source = "${get_parent_terragrunt_dir("root")}/..//terraform/frontend"
}